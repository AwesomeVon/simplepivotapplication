...
$("#billing").on("click", function () {
    if($('li.billing').hasClass("trigger")){
    $('li.billing').removeClass('trigger');
    $("#billing-content").slideUp();
    }
    else{
         $("li.billing").addClass('trigger');
        $("#billing-content").slideToggle();
    }
});

$("#report").on("click", function () {
    if($('li.report').hasClass("trigger")){
    $('li.report').removeClass('trigger');
    $("#report-content").slideUp();
    }
    else{
         $("li.report").addClass('trigger');
